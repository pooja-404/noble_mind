...
export default function Headersec() {
    ...
    return (
        <div className="min-h-[85vh] flex justify-center flex-col relative bg-bg_image  bg-cover xl:bg-BgSize  bg-no-repeat bg-left  ">
            <div className="flex">
                <>
                    <div className=" grow flex-col  justify-center max-w-[1140px] mx-auto  px-3">
                        <div className=" flex gap-2 max-lg:justify-center items-center">
                            ...
                            <p className="text-[#131200] font-Exo sm:text-base text-sm font-normal md:leading-[24px]">AI With Noble Mind</p>
                        </div>
                        <h2 className="text-[#000] lg:max-w-[584px] font-Outfit  lg:text-[64px] sm:text-6xl text-4xl font-light md:leading-[76.8px] max-lg:text-center">Inspiring Innovation, Elevating Solutions – <span className="font-Montserrat font-extrabold ">Noble Mind</span>"</h2>
                        <p className="text-[#131200] lg:max-w-[584px]  font-Exo md:text-base text-sm font-normal md:leading-[24px] opacity-[70%] max-lg:text-center pt-2">At Noble Mind is a forward-thinking AI specialised company dedicated to reshaping the future of how we live, work, and learn. Our mission is to create ground-breaking AI solutions for Healthcare, Education, and beyond, aligning with Saudi Arabia’s Vision 2030.”</p>
                    </div>
                </>
            </div>
        </div>
