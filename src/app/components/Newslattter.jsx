        ...
        <div className="relative z-1 max-lg:mt-[-86px] px-3" id="blogs">
            <div className="max-w-[1140px] container mx-auto px-3 bg-bg_image2 md:h-[318px] h-full py-7 md:py-0 rounded-[20px] flex  justify-center flex-col translate-y-20">
                ...
                <div className='sm:pl-5 pl-2 pr-2 sm:pr-3 box-border py-2 bg-[#FFFFFF0D] rounded-[6px] border border-[#FDFDFF33] mx-auto md:w-[448px]  w-full flex justify-between items-center mt-5 lg:mt-10 ' data-aos="zoom-in-down">
                    <input type="text" placeholder='Enter your email' className='placeholder:text-[#FDFDFF] placeholder:font-Outfit  max-[345px]:w-[80%] placeholder:font-semibold placeholder:sm:text-base placeholder:text-[11px] placeholder:md:leading-[24px] outline-0 bg-transparent' />
