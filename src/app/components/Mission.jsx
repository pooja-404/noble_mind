            ...
            <div className="max-w-[1140px] container mx-auto px-3 md:my-16 my-10 lg:my-24" id="about">
                <div className="flex flex-wrap flex-row -mx-3">
                    ...
                    <div className="lg:w-1/2 w-full px-3  pt-7 lg:pt-0"data-aos="fade-left">
                        ...
                        <h2 className="text-[#000000]  font-Outfit  lg:text-[48px]  sm:text-5xl text-3xl font-light md:leading-[57.6px] md:pt-3 pt-2 max-lg:text-center ">Pioneering Vision & Mission- <span className="font-Outfit font-semibold ">Driven Sectoral Innovation</span></h2>
                        <p className="text-[#000000] lg:max-w-[491px] font-Exo sm:text-base text-sm font-normal md:leading-[24px] md:pb-9 pb-4 pt-3 md:pt-4 max-lg:text-center opacity-[70%]">Imagine a future in Saudi Arabia influenced by the potential of Al, with Noble Mind at the forefront of this transformation. Healthcare stands to gain with the promise of enhanced data precision. In education, there&&apos;s the potential for individualized learning experiences. Finance could witness seamless transactions, and entertainment may revel in customized experiences. Through Al,&apos;s promise, transportation could innovate and cities might adapt smarter infrastructures. In every domain, the vision of Noble Mind hints at a brighter, more efficient nation.</p>
