...
export default function Mission() {
    return(
        <div className="relative z-1">
            <div className="max-w-[1140px] mx-auto px-3 my-24">
                <div className="flex flex-wrap flex-row -mx-3">
                    ...
                    <div className="lg:w-1/2 w-full px-3 lg:pl-10 pt-7 lg:pt-0 ">
            ...
            <Image
                ...
                height={95.49} className="object-contain absolute -top-28 left-7 -z-10 lg:block hidden" />
            <Image
