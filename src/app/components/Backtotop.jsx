...
export default function Backtotop() {
    ...
    return (
        isVisible &&
        <>
            <div onClick={scrollToTop} className=' overflow-hidden '>
                <button className="bg-btngradient group duration-300 hover:scale-95  fixed bottom-5 right-3 sm:right-5 rounded-full p-3 animate-bounce">
