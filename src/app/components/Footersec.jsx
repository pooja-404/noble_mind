...
import { FooterFacebook, FooterInsta, FooterTwiter, FooterLinkdin, FooterLogo } from "./Icons"
                        ...
                        <div className='flex flex-wrap flex-row -mx-3'>
                            ...
                            <div className='w-1/2 px-3  lg:flex justify-end flex-col items-end '>
                                <ul>
                                    ...
                                    <li className='lg:pt-3 pt-2'><a href="tel:6295550129" className='font-Exo sm:text-base text-sm font-normal md:leading-[24px] text-[#FDFDFF] opacity-[70%] relative after:absolute after:w-0 after:h-[2px] hover:after:absolute after:bottom-[-5px] hover:after:w-full after:left-[50%] transition-all duration-500 after:hover:left-0 after:transition-all after:duration-500 hover:after:bg-[#A854E9] '>(629) 555-0129</a></li>
                                </ul>
