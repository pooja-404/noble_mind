...
export default function Preloder() {
    return (
        ...
        <div className="bg-[#040404] min-h-screen fixed h-full w-full flex   items-center z-30  mx-auto">
            <div
                className="w-[10rem] h-[10rem] animate-bounce ing grid place-items-center absolute top-[40%] sm:right-[44%] xs:right-[30%] [transition:all_400ms_ease] hover:-translate-y-[1rem] mx-auto">
