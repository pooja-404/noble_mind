        ...
        <>
            <div className="relative z-10 lg:pt-24 pb-10" id="faq">
                <div className="max-w-[774px] mx-auto px-3" data-aos="zoom-in">
                    ...
                    <Accordion
                        className={`border  mb-5 rounded-[10px] shadow-[0px_4px_32px_0px_#00000014] border-[#A854E933] after:w-full relative after:absolute after:h-[5px] after:bg-[#A854E9] after:bottom-0 after:left-0 after:right-0 overflow-hidden  ${open === 2 ? "border-[#A854E9] after:block" : "after:hidden"} py-5 px-5`}
                        open={open === 2}
                    ...
                    <Accordion
                        className={`border  mb-5 rounded-[10px] shadow-[0px_4px_32px_0px_#00000014] border-[#A854E933] after:w-full relative after:absolute after:h-[5px] after:bg-[#A854E9] after:bottom-0 after:left-0 after:right-0 overflow-hidden  ${open === 3 ? "border-[#A854E9] after:block" : "after:hidden"} py-5 px-5`}
                        open={open === 3}
                    ...
                    <Accordion
                        className={`border  mb-5 rounded-[10px] shadow-[0px_4px_32px_0px_#00000014] border-[#A854E933] after:w-full relative after:absolute after:h-[5px] after:bg-[#A854E9] after:bottom-0 after:left-0 after:right-0 overflow-hidden  ${open === 4 ? "border-[#A854E9] after:block" : "after:hidden"} py-5 px-5`}
                        open={open === 4}
                    ...
                    <Accordion
                        className={`border  mb-5 rounded-[10px] shadow-[0px_4px_32px_0px_#00000014] border-[#A854E933] after:w-full relative after:absolute after:h-[5px] after:bg-[#A854E9] after:bottom-0 after:left-0 after:right-0 overflow-hidden  ${open === 5 ? "border-[#A854E9] after:block" : "after:hidden"} py-5 px-5`}
                        open={open === 5}
